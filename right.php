...
$this->add_right("media", "media", "staff", view:true, add:true, edit:true);
$this->add_right("media", "media", "registered", view:true, add:true);
$this->add_right("media", "media", "guest", view:true, );
